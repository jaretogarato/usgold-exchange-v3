<OpenP textAlign='center'>
    <strong><u>USG TOKEN PURCHASE AGREEMENT</u></strong>
</OpenP>
<OpenP>
    This USG Token Purchase Agreement (this “<u>Agreement</u>”) contains the
    terms and conditions that govern your use of the USG distribution smart
    contract (the “<u>USG Distribution Contract</u>”); use of the related
    ERC-20 USG token smart contact (the “USG Token Contract”); and purchase of
the ERC-20 compatible tokens distributed on the Ethereum blockchain (the “    <u>USG Tokens</u>”) and is an agreement between you or the entity that you
    represent (“<u>Buyer</u>” or “<u>you</u>”) and US Gold Currency LLC, a
Wyoming limited liaiblity company (together with its affiliates, “    <u>Company</u>”). Buyer and Company are herein referred to individually as
    a “<u>Party</u>” and collectively, as the “<u>Parties</u>”.
</OpenP>
<OpenP>
    NOW, THEREFORE, in consideration of the mutual representations, warranties
    and agreements contained in this Agreement, and for other good and valuable
    consideration, the receipt and sufficiency of which are hereby
    acknowledged, Company and Buyer agree as follows:
</OpenP>
...
<OpenP>
    <strong>Buyer acknowledges, understands and agrees</strong>
    to the following: <strong></strong>
</OpenP>
<OpenP>
    BINDING AGREEMENT: Buyer understands and agrees that Buyer is subject to
    and bound by this Agreement by virtue of Buyer’s purchase of USG Tokens.
</OpenP>
<OpenP>
    EXCEPT AS SET FORTH IN THE US GOLD CURRENCY LLC WEBSITE (USGOLD.IO), USG
    TOKENS HAVE NO RIGHTS, USES OR ATTRIBUTES. The USG Tokens do not have any
    ...
    functionalities or features on the Platform. Company does not guarantee and
    is not representing in any way to Buyer that the USG Tokens have any
    rights, uses, purpose, attributes, functionalities or features.
</OpenP>
<OpenP>
    NOT A PURCHASE OF USG TOKENS. Buyer acknowledges, understands and agrees
    that Buyer should not expect and there is no guarantee or representation
    made by Company that Buyer will receive any other product, service, rights,
    attributes, functionalities, features or assets of any kind whatsoever,
    including, without limitation, any cryptographic tokens or digital assets
    now or in the future whether through receipt, exchange, conversion,
...
<div>
    ...
    <OpenH3>
        ...
        <strong>AND PURCHASE OF USG TOKENS</strong>
    </OpenH3>
    <OpenH4>
    ...
    <OpenH3>
        <strong>USG TOKEN DISTRIBUTION</strong>
    </OpenH3>
    <OpenH4>
...
Company intends to allocate and distribute USG Tokens (the “        <u>Token Distribution</u>”) in accordance with Schedule A, including
    ...
    <OpenH3>
        <strong>NO OTHER RIGHTS CREATED</strong>
    </OpenH3>
    <OpenH4>
    ...
    <OpenH3>
        <strong>SECURITY AND DATA; TAXES</strong>
    </OpenH3>
    <OpenH4>
        Section 4.1 Security and Data Privacy.
    </OpenH4>
    <OpenH5>
        <a name="_Hlk513035330">(a) <u>Buyer’s Security</u></a>
    ...
    <OpenH3>
        <strong>REPRESENTATIONS AND WARRANTIES OF BUYER</strong>
    </OpenH3>
</div>
<OpenP>
...
<div>
    ...
    <OpenH5>
        ...
        nominee in connection with USG Tokens, is the subject of sanctions
administered or enforced by any country or government (collectively, “        <u>Sanctions</u>”) or is organized or resident in a country or
...
<OpenP>
    Section 7.12. <u>Failure to Map a Public Key to Buyer’s Account</u>.
    Failure of Buyer to map a public key to Buyer’s account may result in third
    parties being unable to recognize Buyer’s USG Token balance on the Ethereum
    blockchain.
</OpenP>
<div>
    <OpenH4>
    ...
    <OpenH3>
        <strong>LIMITATION OF LIABILITY; INDEMNIFICATION</strong>
    </OpenH3>
    <OpenH4>
...
<OpenP>
    <a name="_Hlk513037082"><strong>Name :____________________</strong></a>
</OpenP>
<OpenP>
    <strong>Date:______________________</strong>
</OpenP>
<OpenP>
    <strong>Location: __________________</strong>
</OpenP>
<OpenP>
    <strong></strong>
</OpenP>
...
the Ethereum protocol is available at https://    <a href="http://www.ethereum.org/">www.ethereum.org/</a> to assist
...
<OpenP>
• Expectations among <a name="OLE_LINK3"></a>    <a name="OLE_LINK4">Platform </a>or other blockchain assets participants
...
<OpenP>
    27. Cryptographic tokens are a new and untested technology. In addition to
    the risks discussed, there are risks that the Company team cannot
    anticipate. Further risks may materialize as unanticipated combinations or
variations of the discussed risks or the emergence of new risks.    <strong></strong>
</OpenP>
