(function (global, factory) {
	...
	*/
	...
	var Subscribe = function (_React$Component) {
	  ...
	  Subscribe.prototype._createInstances = function _createInstances(map, containers) {
	    ...
	    var instances = containers.map(function (ContainerItem) {
	      ...
	      if ((typeof ContainerItem === 'undefined' ? 'undefined' : _typeof$2(ContainerItem)) === 'object' && ContainerItem instanceof Container) {
	...
	var AccordionContainer = function (_Container) {
	    ...
	    _createClass(AccordionContainer, [{
	        key: 'setAccordion',
	        value: function setAccordion(accordion) {
	            if (accordion !== this.state.accordion) {
	                return this.setState({ accordion: accordion });
	            }
	            return null;
	        }
	    }, {
	        ...
	        value: function setOnChange(onChange) {
	            if (onChange !== this.state.onChange) {
	                return this.setState({ onChange: onChange });
	            }
	            return null;
	        }
	    }, {
	...
	*/
	...
	var AccordionItem = function (_Component) {
	    ...
	    _createClass$3(AccordionItem, [{
	        ...
	        value: function render() {
	            ...
	            var currentItem = accordionStore.state.items.find(function (item) {
	...
	var AccordionItemWrapper = function (_Component) {
	    ...
	    _createClass$4(AccordionItemWrapper, [{
	        key: 'render',
	        value: function render() {
	            var _this2 = this;
	...
	var AccordionItemTitle = function (_Component) {
	    ...
	    function AccordionItemTitle() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn$6(this, (_ref = AccordionItemTitle.__proto__ || Object.getPrototypeOf(AccordionItemTitle)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
	            ...
	            var state = accordionStore.state;
	            var accordion = state.accordion,
	            ...
	            accordionStore.setExpanded(foundItem.uuid, !foundItem.expanded).then(function () {
	                if (accordion) {
	                    onChange(foundItem.uuid);
	                } else {
	                    onChange(accordionStore.state.items.filter(function (item) {
	    ...
	    _createClass$5(AccordionItemTitle, [{
	        key: 'render',
	        value: function render() {
	            var _props$accordionStore = this.props.accordionStore.state,
	            ...
	            var _props = this.props,
	                ...
	                accordionStore = _props.accordionStore,
	                rest = _objectWithoutProperties$3(_props, ['uuid', 'className', 'hideBodyClassName', 'accordionStore']);
	...
	var AccordionItemTitleWrapper = function AccordionItemTitleWrapper(props) {
	    return React__default.createElement(
	        ...
	        { to: [AccordionContainer, ItemContainer] },
	        function (accordionStore, itemStore) {
	            return React__default.createElement(AccordionItemTitle, _extends$7({}, props, {
	...
	var AccordionItemBody = function AccordionItemBody(props) {
	    var accordionStore = props.accordionStore,
	        ...
	        rest = _objectWithoutProperties$4(props, ['accordionStore', 'uuid', 'className', 'hideBodyClassName']);

	    var _props$accordionStore = props.accordionStore.state,
	        items = _props$accordionStore.items,
	        accordion = _props$accordionStore.accordion;
	...
	var AccordionItemBodyWrapper = function AccordionItemBodyWrapper(props) {
	    return React__default.createElement(
	        ...
	        { to: [AccordionContainer, ItemContainer] },
	        function (accordionStore, itemStore) {
	            return React__default.createElement(AccordionItemBody, _extends$9({}, props, {
	                uuid: itemStore.state.uuid,
	                accordionStore: accordionStore
	            }));
	        }
